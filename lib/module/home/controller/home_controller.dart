...
class HomeController extends State<HomeView> {
  ...
  String getFormattedDate() {
    ...
    var formatter = DateFormat('EEEE', 'id'); // 'id' for Indonesian locale
  ...
  List<Map<String, dynamic>> dayList = [
    {"day": "senin", "height": 40.0},
    {"day": "selasa", "height": 60.0},
    {"day": "rabu", "height": 40.0},
    {"day": "kamis", "height": 70.0},
    {"day": "jum'at", "height": 40.0},
    {"day": "sabtu", "height": 60.0},
    {"day": "minggu", "height": 40.0},
  ];
